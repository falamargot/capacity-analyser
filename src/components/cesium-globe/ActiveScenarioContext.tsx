...
const ActiveScenarioContext: React.FC<ActiveScenarioContextProps> = ({
    ...
    return (
        <aside
            className={`pointer-events-none absolute left-2 z-[36] max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border border-white/10 bg-slate-950/72 text-white shadow-sm backdrop-blur-md ${
                isPhone
                    ? `${isFullscreen
