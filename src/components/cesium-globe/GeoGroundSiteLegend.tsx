...
const GeoGroundSiteLegend: React.FC<GeoGroundSiteLegendProps> = ({
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute bottom-3 right-20 z-20 w-[230px] max-w-[calc(100vw-1rem)] rounded-lg border border-slate-700/75 bg-slate-950/82 p-2.5 text-slate-100 shadow-[0_18px_44px_-28px_rgba(2,6,23,0.9)] ring-1 ring-white/8 backdrop-blur-md"
    >
