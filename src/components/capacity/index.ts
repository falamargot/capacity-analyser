...
export { TERMINAL_PROFILES, WEATHER_PROFILES, toWeatherCondition, getWeatherFactor } from './terminalAssumptions';
export { TerminalTypeControl, WeatherControl } from './TerminalConfig';
