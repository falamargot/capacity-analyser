...
const ConfidenceBreakdown = ({ confidence }: ConfidenceBreakdownProps) => {
  ...
  return (
    <div className="mt-1.5">
      <div className="flex h-2.5 w-full overflow-hidden rounded-full border border-slate-800 bg-slate-900">
      ...
      <div className="mt-1.5 flex flex-wrap gap-x-3 gap-y-1">
        {confidence.factors.map((factor) => (
          <div key={factor.id} className="flex items-center gap-1 text-[9px] leading-snug text-slate-500">
      ...
      {appliedCap && (
        <div className="mt-1.5 rounded-md border border-amber-700/50 bg-amber-950/30 px-2 py-1 text-[9px] leading-snug text-amber-300">
