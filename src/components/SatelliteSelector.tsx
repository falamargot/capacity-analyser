  ...
  return (
    <div className="relative min-w-0 flex-1">
      ...
      <select
        ...
        className="w-full min-w-0 pl-10 pr-8 py-2 border border-gray-300/85 dark:border-slate-700/80 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white/85 dark:bg-slate-900/72 backdrop-blur-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
      >
