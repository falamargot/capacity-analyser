                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <Field label="Planes P">
                            <input
                                type="number" min={1} max={24} step={1} className={fieldClass}
                                value={reference.planes}
                                onChange={(e) => setReference({
                                    planes: Math.max(1, Math.min(24, Math.round(Number(e.target.value) || 1))),
                                })}
                            />
                        </Field>
                        <Field label="Sats / plane S">
                            <input
                                ...
                                onChange={(e) => setReference({
                                    satsPerPlane: Math.max(1, Math.min(24, Math.round(Number(e.target.value) || 1))),
                                })}
                            />
                        </Field>
                        <Field label="Inclination °">
                            <input
                                ...
                                onChange={(e) => setReference({ inclinationDeg: Number(e.target.value) })}
                            />
                        </Field>
                        <Field label="Altitude km">
                            <input
                                ...
                                onChange={(e) => setReference({ altitudeKm: Number(e.target.value) })}
                            />
                        </Field>
                        <Field label="Phasing f" hint={
                            ...
                            <input
                                ...
                                onChange={(e) => setReference({ phasingF: Number(e.target.value) })}
                            />
                        </Field>
                        <Field label="Fudge" hint="scales the RAAN step">
                            <input
                                ...
                                onChange={(e) => setReference({ fudge: Number(e.target.value) || 1 })}
                            />
                        </Field>
                        <Field label="Total">
                ...
                <div className="border-t border-slate-700/60 pt-2.5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <Field label="Duration h" hint="below 24 h is unreliable">
                            <input
                                type="number" min={1} max={240} step={1} className={fieldClass}
                                value={analysisWindow.durationHours}
                                onChange={(e) => onChange({
                                    ...scenario,
                                    window: {
                                        ...analysisWindow,
                                        durationHours: Math.max(1, Number(e.target.value) || 1),
                                    },
                                })}
                            />
                        </Field>
                        <Field label="Step s" hint="must be ≪ shortest pass">
                            <input
                                type="number" min={1} max={120} step={1} className={fieldClass}
                                value={analysisWindow.stepSeconds}
                                onChange={(e) => onChange({
                                    ...scenario,
                                    window: {
                                        ...analysisWindow,
                                        stepSeconds: Math.max(1, Number(e.target.value) || 1),
                                    },
                                })}
                            />
                        </Field>
